...
function home(identity) {
  ...
  <section class="approach paper" id="approach"><img class="chapter-vignette chapter-deer" src="/assets/clean/chapter-deer.png" width="900" height="600" loading="lazy" alt="" aria-hidden="true"><img class="floating-accent floating-sprig approach-sprig" src="/assets/clean/floating-sprig.png" width="320" height="320" loading="lazy" alt="" aria-hidden="true"><div class="shell"><p class="kicker">How I work</p><h2>I bring <em>context, creativity,</em> and <em>care</em> to every project.</h2><p class="lede">I take time to understand the business, the people, and the constraints. Then I craft technology solutions that make sense. Solutions that are sustainable, budget-conscious, and built to support growth and profitability.</p><div class="steps" data-accordion>${processStep(1,'understand','Understand','I listen first. I dig into the business, users, market, and constraints.')}${processStep(2,'creative','Solve creatively','I design thoughtful solutions that are pragmatic, elegant, and fit for purpose.')}${processStep(3,'team','Right-sized teams','I work with the right people, tools, and level of complexity for the job.')}${processStep(4,'constraints','Respect constraints','I plan around real budgets, timelines, and support needs.')}${processStep(5,'results','Drive results','I focus on profit, efficiency, and sustainable growth for the long term.')}${processStep(6,'growth','Plan for growth','I build roadmaps that create momentum and adapt as you grow.')}</div></div><a class="section-cue" href="#selected-work" aria-label="Continue to selected work"><span>↓</span></a></section>
