...
const identities = {
  bri: { name: 'Bri', host: 'bri.bryantjames.com', email: 'bri@bryantjames.com', github: 'the-jolly-green-bryant' },
  bryant: { name: 'Bryant', host: 'bryantjames.com', email: 'bryant@bryantjames.com', github: 'the-jolly-green-bryant' }
};
...
function header(identity, page) {
  return `<header class="site-head"><a class="brand" href="/" aria-label="${identity.name} home"><span>${identity.name}</span><img src="/assets/clean/brand-botanical-crisp.png" width="1254" height="1254" alt="" aria-hidden="true"></a><nav aria-label="Primary"><a${page === 'work' ? ' aria-current="page"' : ''} href="/work/">Work</a><a href="/#approach">Approach</a><a href="/#about">About</a><a href="/contact/">Contact</a></nav><details class="menu"><summary aria-label="Open menu"><i></i><i></i><i></i></summary><div><a href="/work/">Work</a><a href="/#approach">Approach</a><a href="/#about">About</a><a href="/contact/">Contact</a></div></details></header>`;
}

function footer(identity) {
  return `<footer id="site-footer"><div><a class="brand light" href="/"><span>${identity.name}</span><img src="/assets/clean/brand-botanical-crisp.png" width="1254" height="1254" alt="" aria-hidden="true"></a><p>Software engineer blending creativity,<br>strategy, and code to build software<br>that makes a difference.</p></div><div><small>Navigate</small><a href="/work/">Work</a><a href="/#approach">Approach</a><a href="/#about">About</a><a href="/contact/">Contact</a></div><div><small>Let’s connect</small><a href="https://github.com/${identity.github}">GitHub</a><a href="https://linkedin.com/in/bryantjames">LinkedIn</a><a href="mailto:${identity.email}">Email</a></div><div class="portland"><img src="/assets/clean/portland-line-crisp.png" width="1771" height="888" loading="lazy" alt="Crisp line drawing of the Portland skyline, bridge, forest, and Mount Hood"><span>Made with care in Portland, Oregon <b aria-hidden="true">♡</b></span></div></footer>`;
}
...
function home(identity) {
  ...
  <section class="about paper" id="about"><div class="shell about-grid"><div><p class="kicker">A little about me</p><h2><span>I’m a thought partner,</span><span>not just a developer.</span></h2><p>The best software solves the right problem in the right way. I bring a blend of technical expertise, business acumen, and creative thinking to every project. I care about clarity, communication, and building lasting partnerships.</p><div class="values" id="values-slider" data-slider>${aboutValue('about-teacup','Empathetic & curious','I listen deeply and ask the right questions.')}${aboutValue('about-lantern','Clear & collaborative','I keep things transparent and move as a team.')}${aboutValue('about-flower','Practical & grounded','I ship solutions that make sense today and scale tomorrow.')}</div>${railControls('values-slider','values')}</div></div><div class="about-closing"><p class="note">It’s not just about the code.<br>It’s about the outcome. ♡</p><div class="about-art"><span aria-hidden="true"></span><img class="about-garden-left" src="/assets/clean/about-garden-left-hd.png" width="1440" height="1132" loading="lazy" alt="Mushrooms, daisies, lavender, and wildflowers"><img class="about-garden-right" src="/assets/clean/about-garden-right-hd.png" width="696" height="1132" loading="lazy" alt="Lavender and a glowing botanical lantern"></div></div><a class="section-cue" href="#site-footer" aria-label="Continue to the footer"><span>↓</span></a></section>`);
}
